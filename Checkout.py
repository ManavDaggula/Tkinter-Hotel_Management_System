...
# now the header
lbl_checkout=tk.Label(root, text="Checkout", font=("Segoe Script",20), bg="#01030e", fg="#e31d16")
...
frm_checkout = tk.Frame(root, bg="#01030e")
frm_checkout.pack(fill="both",expand=True,side=tk.LEFT)

img_lbl = tk.PhotoImage(file="checkout_image.png")
lbl_img = tk.Label(root,image=img_lbl,bg="#01030e")
lbl_img.pack(side=tk.RIGHT,fill=tk.BOTH)

#creating the labels to be displayed and dropdown list to be selected from
lbl_1 = tk.Label(frm_checkout,text="Customer ID", bg="#01030e",fg="#79c0ec",font=("Helvetica",15,"bold"))
lbl_1.grid(row=0,column=0)
lbl_2 = tk.Label(frm_checkout,text="Name", bg="#01030e",fg="#79c0ec",font=("Helvetica",15,"bold"))
lbl_2.grid(row=1,column=0)
lbl_3 = tk.Label(frm_checkout,text="Phone", bg="#01030e",fg="#79c0ec",font=("Helvetica",15,"bold"))
lbl_3.grid(row=2,column=0)
lbl_4 = tk.Label(frm_checkout,text="Aadhar", bg="#01030e",fg="#79c0ec",font=("Helvetica",15,"bold"))
lbl_4.grid(row=3,column=0)
lbl_5 = tk.Label(frm_checkout,text="Gender", bg="#01030e",fg="#79c0ec",font=("Helvetica",15,"bold"))
lbl_5.grid(row=4,column=0)
lbl_6 = tk.Label(frm_checkout,text="Check-In Date & Time", bg="#01030e",fg="#79c0ec",font=("Helvetica",15,"bold"))
lbl_6.grid(row=5,column=0)
selected_customer=tk.StringVar()
selected_customer.set("Select a customer ID")
lbl_7 = tk.Label(frm_checkout,text="-", bg="#01030e",fg="yellow",font=(15))
lbl_7.grid(row=1,column=1)
lbl_8 = tk.Label(frm_checkout,text="-", bg="#01030e",fg="yellow",font=(15))
lbl_8.grid(row=2,column=1)
lbl_9 = tk.Label(frm_checkout,text="-", bg="#01030e",fg="yellow",font=(15))
lbl_9.grid(row=3,column=1)
lbl_10 = tk.Label(frm_checkout,text="-", bg="#01030e",fg="yellow",font=(15))
lbl_10.grid(row=4,column=1)
lbl_11 = tk.Label(frm_checkout,text="-", bg="#01030e",fg="yellow",font=(15))
...
btn_next = tk.Button(frm_checkout,text="Next",bg="#01030e", fg="yellow",command=lambda: func.perform_checkout(frm_checkout,selected_customer.get()),font=(15))
